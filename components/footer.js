                        ...
                        <div className="grid lg:md:grid-cols-2 lg:md:gap-16 lg:md:mt-2 sm:mt-4 sm:grid-cols-1 sm:gap-6">
                            <div>
                                ...
                                <div className="grid grid-cols-3 flex">
                                    ...
                                    <a href="tel:+48608076432" className="text-sm font-semibold leading-6 hover:text-green-biterum">608076432</a>
                                    <div className="col-span-2 gap-2 flex items-center">
                                        <Image
                                            priority
                                            src={phoneIcon}
                                    ...
                                    <a href="tel:+48698859590" className="text-sm font-semibold leading-6 hover:text-green-biterum">698859590</a>
                                    <div className="col-span-2 gap-2 flex items-center">
                                        <Image
                                            priority
                                            src={phoneIcon}
                                            ...
                                            height={16}
                                        />
                                        <p className="text-sm leading-6">logistyka i administracja</p>                   
                                    </div>
                                    <a href="tel:+48694424042" className="text-sm leading-6 font-semibold hover:text-green-biterum">694424042</a>
                                    ...
                                    <div className="col-span-2 text-right mr-5">
                                        <a href="mailto:zapytanie@biterum.pl" className="text-sm leading-6 font-semibold hover:text-green-biterum">zapytanie@biterum.pl</a>
                                    </div>
                            ...
                            <Footer.Title title="Dane firmy"/>
                                <div className="grid grid-cols-2 gap-7">
                                    <div className="grid grid-row-4 gap-1 text-sm text-left flex">
                                        <p className="font-semibold">BITERUM Sp. z o. o. sp. k.</p>
